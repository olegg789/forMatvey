...
function MajorNotes({majorNotes, router, isDesktop, editNote, openSnackbar, allNotes, getNotes}) {
    ...
    return (
        <>
            ...
            <Footer>Всего {majorNotes.count} {declOfNum(majorNotes.count, ['заметка', 'заметки', 'заметок'])}</Footer>
            {snackbarDel}
        </>
    )
};

export default MajorNotes;
